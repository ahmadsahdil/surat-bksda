...
$pdf->SetAuthor('BKSDA');
$pdf->SetTitle('Laporan Disposisi Keluar');
...
$table.='<tr >
      ...
      <th style="border:1px solid #000;width:24%;text-align:left" >Tgl &nbsp;&nbsp; &nbsp; &nbsp;: '.date('d M Y',strtotime($data->tanggal_keluar)). ' </th>
...
<tr>
        ...
        <td  style="border:1px solid #000;width:84%; ">'.$data->kepada. '</td>
      </tr>
      ';
          $table.='
...
<tr>
        ...
        <td  style="border:1px solid #000;width:60%; \">'.$data->nomorKeluar. '</td>
...
ob_clean();
$pdf->Output('Disposisi Keluar.pdf', 'I');
